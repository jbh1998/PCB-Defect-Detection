...
class AnchorBoxes(Layer):
    ...
    def __init__(self,
        ...
        self.this_steps = this_steps  # TSL: None
        self.this_offsets = this_offsets # TSL: None
        self.clip_boxes = clip_boxes  # TSL: False
        self.variances = variances  # TSL: 1.0
        self.coords = coords  # TSL: 'centroids'
        self.normalize_coords = normalize_coords # True
    ...
    def call(self, x, mask=None):
        ...
        wh_list = []
        for ar in self.aspect_ratios: # TSL: 0.5,1,2
            if (ar == 1):
                # Compute the regular anchor box for aspect ratio 1.
                box_height = box_width = self.this_scale * size
                wh_list.append((box_width, box_height))
                if self.two_boxes_for_ar1:  # TSL: true
        ...
        if (self.this_steps is None):  # TSL: True
        ...
        if (self.this_offsets is None): # TSL: True
            offset_height = 0.5
            offset_width = 0.5
        else:
        ...
        boxes_tensor = np.zeros((feature_map_height, feature_map_width, self.n_boxes, 4))  # self.n_boxes = 3 + 1 = 4
        ...
        if self.normalize_coords: # TSL: True
        ...
        variances_tensor += self.variances # Long live broadcasting # TSL: self.variances = 1.0
